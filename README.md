...
> **สถานะ:** กำลังพัฒนา ยังไม่มีบน Chrome Web Store ติดตั้งจากซอร์สได้ตามขั้นตอนด้านล่าง
...
- สรุปหลังประชุม: ภาพรวม, หัวข้อ, การตัดสินใจ, action items, ความเสี่ยง, คำถามที่ต้องตามต่อ
...
5. กด **Stop** หรือออกจากห้อง ไฟล์จะเซฟให้อัตโนมัติ
...
ถ้าสรุปไม่สำเร็จ transcript ยังอยู่ กด **สรุปใหม่** ใน Side Panel ได้
