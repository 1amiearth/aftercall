...
- Start / Pause / Resume / Stop แล้วได้ `recording.webm`, `transcript.md`, `review.html` และเปิด `review.html` แล้วกดเวลาให้วิดีโอกระโดดได้
- กดสรุปแล้ว `review.html` ถูกแทนด้วยฉบับที่มีสรุป ไม่เกิด `review (1).html` และ Chrome ไม่เตือนว่าไฟล์อันตราย
